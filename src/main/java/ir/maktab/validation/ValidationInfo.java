...
public class ValidationInfo {
    ...
    public static boolean isValidProposedPrice(double proposedPrice, double basePrice) {

        if (proposedPrice >= basePrice)
            return true;
        throw new InValidUserInfoException("--- The price entered is lower than the base price for this ir.maktab.service ---");
    }
}
